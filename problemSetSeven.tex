    ...
    \begin{enumerate}
      \item Check that the spin matrices (Equations 4.145 and 4.147) obey the fundamental commutation relations for angular momentum, Equation 4.134.
        ...
        \textcolor{hwColor}{
          ...
          $$
          $
            \left[S_x, S_y\right]=S_xS_y-S_yS_x=\dfrac{\hbar^2}{4} \left[
              \begin{pmatrix}
                0 & 1
                \\
                1 & 0
            ...
            =\dfrac{\hbar^2}{4} \begin{pmatrix}
              ...
              0 & -2i
            \end{pmatrix}
            =\dfrac{i \hbar^2}{2} \begin{pmatrix}
              1 & 0
              \\
              0 & -1
            \end{pmatrix}
            ...
            \\
            \\
            \therefore ~~~ \left[S_x, S_y\right]=i \hbar S_z ~~~~ \checkmark
            \\
          $
        }
      ...
      $jk \ell=123, 231,$ or $312; -1$ if $jk \ell=132, 213,$ or $321; 0$ otherwise.
        ...
        \textcolor{hwColor}{
          ...
          $
            ...
            \\
            \begin{cases}
              \sigma_x \sigma_x=\sigma_y \sigma_y=\sigma_z \sigma_z=\begin{pmatrix}
                1 & 0
                \\
                0 & 1
              \end{pmatrix}=1
          ...
          \\
          \\
          From the textbook we have equation (4.148) as
          \\
          \\
          $
          ...
          \\
          \\
          Based on the results we have, we can see that the given equation in this problem satisfies all of them. $~~~ \checkmark$
          \\
        }
